module.exports = function (grunt){
    ...
    grunt.initConfig({
        ...
        useminPrepare: {
            foo: {
                dest: 'dist',
                src: ['index.html','contacto.html','precios.html','terminos.html','about.html']
            },
            options: {
                flow: {
                    steps: {
        ...
        usemin: {
            html:['dist/index.html','dist/contacto.html','dist/precios.html','dist/terminos.html','dist/about.html'],
            options: {
